 ...
 */
	...
	web : {
		...
		"l_category" : "CategorÃ­a",
		"l_subcategory" : "SubcategorÃ­a",
		"l_user_panel" : "Panel de usuario",
		"l_order_list" : "Ã“rdenes",
	},
	template : {
		product_thumb : {
		...
		product : {
			...
			"l_format" : "Formato",
			"l_language" : "Idioma",
			"l_subtitles" : "SubtÃ­tulos",
			"l_region" : "Region",
			"l_aspect_ratio" : "Proporciones",
			"l_number_discs" : "NÃºmero de discos",
			"l_release_date" : "Fecha de lanzamiento",
			"l_run_time" : "DuraciÃ³n",
			"l_ASIN" : "ASIN(CÃ³digo de identificaciÃ³n Ãºnica de Amazon)",
			"l_authors" : "Autores",
			"l_publisher" : "Publicador",
			"l_published_date" : "Fecha de publicaciÃ³n",
			"l_ISBN_10" : "ISBN 10",
			"l_ISBN_13" : "ISBN 13",
			"b_buy" : "Comprar",
			"b_for" : "por",
		...
		userNav : {
			...
			"l_last_login" : "Ãšltimo ingreso",
			"b_signout" : "Cerrar sessiÃ³n",
		...
		register:{
			...
			l_username: "Usuario",
			l_password: "ContraseÃ±a",
			l_confirm_password: "Confirmar contraseÃ±a",
			l_name: "Nombre",
			l_email: "Email",
		...
		address_form:{
			l_title: "Direcciones",
			l_full_name: "Nombre completo",
			l_address_line: "DirecciÃ³n lÃ­nea",
			l_zip_code:"CÃ³digo postal",
			l_phone_number:"TelÃ©fono",
			l_country:"PaÃ­s",
			l_state:"Provincia",
			l_city:"Ciudad",
			l_new_name:"Nombre de una nueva direcciÃ³n",
			b_update: "Actualizar",
			b_delete: "Borrar",
			l_new: "Nueva direcciÃ³n",
			b_new: "Crear Nueva",
			b_back: "AtrÃ¡s"
		},
		order_detail:{
		...
		change_password:{
			l_changepassword: "Cambiar contraseÃ±a",
			l_currpassword: "ContraseÃ±a actual",
			l_password: "Nueva ContraseÃ±a",
			l_confirm_password: "Confiramr contraseÃ±a",
			h_required: "requerido",
			b_submit: "Cambiar"
		},
		checkout: {
	...
	validator : {
		  ...
		  dateISO: "Por favor, escribe una fecha (ISO) vÃ¡lida. (yyyy-mm-dd)",
